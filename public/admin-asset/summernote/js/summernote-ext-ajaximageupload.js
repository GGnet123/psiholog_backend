...
var php_upload_path = "/admin/cabinet/save-image";
    ...
    $.extend($.summernote.plugins, {
        ...
        'ajaximageupload': function(context) {
            ...
            this.initialize = function() {
                this.$panel = $(`
                        <div class="ajaxfileupload-panel">
                            <div id="ajaxFileUploadInner">
                                <div id="ajaxPanelClose">+</div>
                                <div id="fileUploadGroup"><h4>Выберите файл для загрузки :</h4>
                                <br /><input type="file" id="file" name="file"  /></div>
                                <div id="ajaxFileUploadSubmit">Загрузить</div></div></div>`).css({
                    position: 'fixed',
                    width: 400,
                    height: 175,
                    left: '50%',
