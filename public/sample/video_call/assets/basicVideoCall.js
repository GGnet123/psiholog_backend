...
$('#joinAsDoctor').click(function(e){
  $.get( "/admin/sample/video/token", { user_id: 1}).done(async function( data ) {
    options.appid = data.appId;
    options.channel = data.channelName;
    options.uid = data.user_id;
...
$('#joinAsUser').click(function(e){
  $.get( "/admin/sample/video/token", { user_id: 2}).done(async function( data ) {
    options.appid = data.appId;
    options.channel = data.channelName;
    options.uid = data.user_id;
    options.token = data.token;
