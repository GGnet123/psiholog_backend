...
class  MantraController extends Controller{
    protected $view_path = 'page.content.galary.mantra';
    protected $route_path = 'admin_gal_mantra';
    protected $title_path = 'title.admin_gal_mantra';
    protected $def_model = Model::class;
    protected $type = MainGalary::TYPE_MANTRA;
