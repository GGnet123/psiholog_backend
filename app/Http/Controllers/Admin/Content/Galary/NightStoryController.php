...
use App\Models\Content\MainGalary as Model;
use Illuminate\Http\Request;

class  NightStoryController extends Controller{
    protected $view_path = 'page.content.galary.night_story';
    protected $route_path = 'night_story';
    protected $title_path = 'title.night_story';
    protected $def_model = Model::class;
    protected $type = MainGalary::TYPE_NIGHT_STORY;
