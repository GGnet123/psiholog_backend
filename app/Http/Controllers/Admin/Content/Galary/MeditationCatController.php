...
class  MeditationCatController extends Controller{
    protected $view_path = 'page.content.galary.meditation_cat';
    protected $route_path = 'meditation_cat';
    protected $title_path = 'title.meditation_cat';
