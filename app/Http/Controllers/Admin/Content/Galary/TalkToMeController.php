...
class  TalkToMeController extends Controller{
    protected $view_path = 'page.content.galary.talk_to_me';
    protected $route_path = 'admin_gal_talk_to_me';
    protected $title_path = 'title.admin_gal_talk_to_me';
