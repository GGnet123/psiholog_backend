...
class  MeditationController extends Controller{
    protected $view_path = 'page.content.galary.meditation';
    protected $route_path = 'admin_gal_meditation';
    protected $title_path = 'title.admin_gal_meditation';
    protected $def_model = Model::class;
    protected $type = MainGalary::TYPE_MEDITATION;
