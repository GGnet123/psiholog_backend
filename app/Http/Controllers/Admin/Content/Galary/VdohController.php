...
class  VdohController extends Controller{
    protected $view_path = 'page.content.galary.vdoh';
    protected $route_path = 'admin_gal_vdoh';
    protected $title_path = 'title.admin_gal_vdoh';
    protected $def_model = Model::class;
    protected $type = MainGalary::TYPE_VDOH;
