...
class  MeditationAudioController extends Controller{
    protected $view_path = 'page.content.galary.med_audio';
    protected $route_path = 'admin_gal_med_audio';
    protected $title_path = 'title.admin_gal_med_audio';
    protected $def_model = Model::class;
    protected $type = MainGalary::TYPE_MEDITATION_AUDIO;
