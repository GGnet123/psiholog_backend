...
class  NatureController extends Controller{
    protected $view_path = 'page.content.galary.nature';
    protected $route_path = 'admin_gal_nature';
    protected $title_path = 'title.admin_gal_nature';
    protected $def_model = Model::class;
    protected $type = MainGalary::TYPE_NATURE;
