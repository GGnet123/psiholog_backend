...
class  SleepController extends Controller{
    protected $view_path = 'page.content.galary.sleep';
    protected $route_path = 'admin_gal_sleep';
    protected $title_path = 'title.admin_gal_sleep';
    protected $def_model = Model::class;
    protected $type = MainGalary::TYPE_SLEEP;
