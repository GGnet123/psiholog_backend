...
class  AffirmationController extends Controller{
    protected $view_path = 'page.content.galary.affirmation';
    protected $route_path = 'admin_gal_affirmation';
    protected $title_path = 'title.admin_gal_affirmation';
    protected $def_model = Model::class;
    protected $type = MainGalary::TYPE_AFFIRMATION;
