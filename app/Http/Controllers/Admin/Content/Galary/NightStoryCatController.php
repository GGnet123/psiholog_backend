...
class  NightStoryCatController extends Controller{
    protected $view_path = 'page.content.galary.night_story_cat';
    protected $route_path = 'night_story_cat';
    protected $title_path = 'title.night_story_cat';
