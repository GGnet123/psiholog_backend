...
class  AudioBookCatController extends Controller{
    protected $view_path = 'page.content.galary.audio_book_cat';
    protected $route_path = 'audio_book_cat';
    protected $title_path = 'title.audio_book_cat';
    protected $def_model = Model::class;
    protected $type = MainGalary::TYPE_AUDIO_BOOK;
