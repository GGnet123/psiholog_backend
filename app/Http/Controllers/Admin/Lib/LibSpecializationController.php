...
use App\Models\Main\LibSpecialization as Model;
use Illuminate\Http\Request;

class  LibSpecializationController extends Controller{
    protected $view_path = 'page.lib.specialization';
    protected $route_path = 'admin_lib_spec';
    protected $title_path = 'title.lib_spec';
    ...
    public function saveCreate(Request $request, Model $item){
        $action = new MainStoreAction($item, $request->all());
